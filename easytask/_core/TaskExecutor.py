...
class TaskExecutor:
    ...
    def _on_yield_enter(self, yield_value : yield_enter):  
        self._continue_execution = yield_value._section._try_enter(self._task)
        
    def _on_yield_leave(self, yield_value : yield_leave):  
        yield_value._section._leave(self._task)
        self._continue_execution = True
    ...
    _yield_to_func = {
            ...
            yield_enter : _on_yield_enter,
            yield_leave : _on_yield_leave,
        }                  
